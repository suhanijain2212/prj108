...
function getResult(error, results) {
    if (error) {
        ...
        {
            document.getElementById("update_emoji2").innerHTML = "update_emoji2").innerHTML = "&#1285522";
        }
        if(results[1].label == "sad")
        {
            document.getElementById("update_emoji2").innerHTML = "update_emoji2").innerHTML = "&#1285532";
    }
    if(results[1].label == "angry")
    {
        document.getElementById("update_emoji2").innerHTML = "update_emoji2").innerHTML = "&#1285548";
    }
}
